...
public class PaymentSecretCipher {
    ...
    public PaymentSecretCipher(@Value("${app.toss.encryption-key-base64:}") String encodedKey) {
    ...
    private ApplicationException configurationError() {
        return new ApplicationException("PAYMENT_ENCRYPTION_NOT_CONFIGURED", HttpStatus.SERVICE_UNAVAILABLE,
                "결제 보안 설정이 완료되지 않았습니다.");
    }
}
