...
export function LandingPage() {
  ...
  return <main className="landing-page">
    <header className="landing-nav">
      <Link to="/" className="landing-brand"><BrandMark /><strong>Work Task Flow</strong></Link>
    ...
    <section className="landing-product" aria-label={t('제품 화면 미리보기', 'Product preview')}>
      ...
      <div className="landing-product-body">
        <aside><div className="mock-brand"><BrandMark />Work Task Flow</div><span className="active">⌂ {t('홈', 'Home')}</span><span>♧ {t('그룹', 'Groups')}</span><span>□ {t('캘린더', 'Calendar')}</span><span>♢ {t('알림', 'Alerts')}</span><b>{t('로컬 알파 시연팀', 'Alpha demo team')}</b></aside>
