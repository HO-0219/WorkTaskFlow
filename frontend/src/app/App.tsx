...
function pageLabel(pathname: string, language: 'ko' | 'en') {
  if (language === 'en') {
    if (pathname === '/') return 'toegeun'; if (pathname === '/app') return 'Dashboard'; if (pathname === '/calendar') return 'Calendar'; if (pathname === '/notifications') return 'Alerts'; if (pathname === '/assistant') return 'AI assistant';
